...
\end{figure}}
\n{sco}{\rom{score}}
\n{peff}{\rom{particle efficiency}}
\n{pdup}{\rom{particle duplicate rate}}
\n{pfak}{\rom{particle fake rate}}
\n{teff}{\rom{track efficiency}}
\n{tdup}{\rom{track duplicate rate}}
\n{tfak}{\rom{track fak rate}}
\n{runtime}
\n{abseta}{$|\eta|<$}
\n{ttbar}{$t\bar{t}$~}
\n{qqbar}{$q\bar{q}$~}
...
Some terminology is described here. A \ita{sequence} is an ordered list of algorithms beginning at event generation, through CKF reconstruction, and ending at the CKF efficiency analyzer. A \ita{trial} is one sequence with one set of parameters. A \ita{score} is a number calculated given the efficiencies from one trial.
...
\begin{enumerate}
\item Initialize the optimizer and set the first trial paremters to \fref{192837a}.
...
\e{\sco = \preff - \tfak - \tdup / 5 - \runtime / 5}
\figtab{l l}{
...
\figpic{4cm}{/home/user1/time/2023-02-22/2023-02-22-13-30/compare-4/dup.png}{Track duplicate fraction as function of $\eta$, $\phi$, and $\pt$.}
\figpic{4cm}{/home/user1/time/2023-02-22/2023-02-22-13-30/compare-4/eff.png}{Track efficiency fraction as function of $\eta$, $\phi$, and $\pt$.}
\figpic{4cm}{/home/user1/time/2023-02-22/2023-02-22-13-30/compare-4/fak.png}{Track fake fraction as function of $\eta$, $\phi$, and $\pt$.}
...
\figpic{6\cm}{/home/user1/time/2023-02-22/2023-02-22-18-01-01/score.png}{Plot of score per trial}
\figpic{9\cm}{/home/user1/time/2023-02-22/2023-02-22-18-01-01/parameter_per_trial/grid.png}{Parameters per trial.}
\figpic{9\cm}{/home/user1/time/2023-02-22/2023-02-22-18-01-01/efficiency_per_trial/grid.png}{Efficiency per trial.}
The parameters from the trial with the highest score were used to generate 100 events, with 100 pileup particles each. The resulting efficiency plots are below.,
\figpic{4cm}{/home/user1/time/2023-02-23/2023-02-23-04-19/compare-4/dup.png}{Track duplicate fraction as function of $\eta$, $\phi$, and $\pt$.}
\figpic{4cm}{/home/user1/time/2023-02-23/2023-02-23-04-19/compare-4/eff.png}{Track efficiency fraction as function of $\eta$, $\phi$, and $\pt$.}
\figpic{4cm}{/home/user1/time/2023-02-23/2023-02-23-04-19/compare-4/fak.png}{Track fake fraction as function of $\eta$, $\phi$, and $\pt$.}
...
The parameters from the trial with the highest score were used to generate 100 events, with 100 pileup particles each. The resulting efficiency plots are below.,
\figpic{4cm}{/home/user1/time/2023-02-23/2023-02-23-02-45/compare-2/dup.png}{Track duplicate fraction as function of $\eta$, $\phi$, and $\pt$.}
\figpic{4cm}{/home/user1/time/2023-02-23/2023-02-23-02-45/compare-2/eff.png}{Track efficiency fraction as function of $\eta$, $\phi$, and $\pt$.}
\figpic{4cm}{/home/user1/time/2023-02-23/2023-02-23-02-45/compare-2/fak.png}{Track fake fraction as function of $\eta$, $\phi$, and $\pt$.}
\subsection{$\eta$ from -3 to 3, custom score}
The score function is 
\e{\sco=\preff - \tfak - \tdup/5}
...
The parameters from the trial with the highest score were used to generate 100 events, with 100 pileup particles each. The resulting efficiency plots are below.,
\figpic{4cm}{/home/user1/time/2023-02-23/2023-02-23-10-07/compare-1/dup.png}{Track duplicate fraction as function of $\eta$, $\phi$, and $\pt$.}
\figpic{4cm}{/home/user1/time/2023-02-23/2023-02-23-10-07/compare-1/eff.png}{Track efficiency fraction as function of $\eta$, $\phi$, and $\pt$.}
\figpic{4cm}{/home/user1/time/2023-02-23/2023-02-23-10-07/compare-1/fak.png}{Track fake fraction as function of $\eta$, $\phi$, and $\pt$.}
\subsection{$\eta$ from -3 to 3, custom score}
The score function is
...
The parameters from the trial with the highest score were used to generate 100 events, with 100 pileup particles each. The resulting efficiency plots are below.,
\figpic{4cm}{/home/user1/time/2023-02-24/2023-02-24-07-07/compare-2/dup.png}{Track duplicate fraction as function of $\eta$, $\phi$, and $\pt$.}
\figpic{4cm}{/home/user1/time/2023-02-24/2023-02-24-07-07/compare-2/eff.png}{Track efficiency fraction as function of $\eta$, $\phi$, and $\pt$.}
\figpic{4cm}{/home/user1/time/2023-02-24/2023-02-24-07-07/compare-2/fak.png}{Track fake fraction as function of $\eta$, $\phi$, and $\pt$.}
\end{document}
